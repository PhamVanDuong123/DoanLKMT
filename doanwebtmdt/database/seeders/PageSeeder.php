    ...
    public function run()
    {
        DB::table('pages')->insert([
            [
                ...
                'content'=>'<p><strong>[Giới thiệu] Elon Musk nghĩ rằng các công ty lưới điện không có gì phải lo sợ các hệ thống mái ngói năng lượng mặt trời. Nhiều báo cáo cho rằng đang có một “cuộc chiến” giữa các công ty năng lượng mặt trời và các công ty lưới điện tại Hoa Kỳ, xoay quanh một số vấn đề quan trọng.</strong></p>
            ...
            [
                ...
                <p>Tư vấn mua hàng: <a href="tel:1800 1234">1800 1234</a></p>
                <p>Chăm sóc khách hàng: <a href="tel:1800 1234">1800 1234</a>&nbsp;/&nbsp;<a href="mailto:cskh@abc.vn">cskh@abc.vn</a></p>',
                'created_at'=>date('Y-m-d H:m:s',time())
            ]
        ]);
    }
