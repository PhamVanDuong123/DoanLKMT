...
<div id="content" class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            @if(!empty($promotion))
            <form method="post" action="{{route('admin.promotion.update',['id'=>$promotion->id, 'status'=>request()->status])}}">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" cols="30" rows="5">{{$promotion->description}}</textarea>
                                @error('description')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
