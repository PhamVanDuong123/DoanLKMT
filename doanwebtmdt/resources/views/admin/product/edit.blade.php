                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" name="price" id="price" class="form-control money" value="{{$product->price}}">
                            @error('price')
                            <span class="form-text text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" name="old_price" id="old_price" class="form-control money" value="{{$product->old_price}}">
                        </div>
                        <div class="col-md-4 form-group">
                            <label for="price_cost">Giá gốc</label>
                            <input type="text" name="price_cost" id="price_cost" class="form-control money" value="{{$product->price_cost}}">
                            @error('price_cost')
                            <span class="form-text text-danger">{{$message}}</span>
                            @enderror
                        </div>
