                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" name="old_price" id="old_price" class="form-control money">
                            @error('old_price')
                            <span class="form-text text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" name="price_cost" id="price_cost" class="form-control money">
                            @error('price_cost')
                            <span class="form-text text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <textarea name="detail_desc" class="form-control form-editor" id="detail_desc" cols="30" rows="20"></textarea>
                            @error('detail_desc')
                            <span class="form-text text-danger">{{$message}}</span>
                            @enderror
                        </div>
